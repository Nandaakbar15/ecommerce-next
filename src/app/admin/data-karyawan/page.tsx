                ...
                <div className="overflow-x-auto mt-5">
                    ...
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left">Alamay</th>
                        ...
                        {employee.map((karyawan => (
                            <tr key={karyawan.id_karyawan}>
                                ...
                                <td className="border border-gray-300 px-4 py-2">
                                    <Link className="inline-block rounded-lg bg-blue-500 px-4 py-2 text-white font-medium hover:bg-blue-600 transition" href={`/admin/data-produk/ubah-produk/${karyawan.id_karyawan}`}>Edit</Link>
                                </td>
                                <td className="border border-gray-300 px-4 py-2">
